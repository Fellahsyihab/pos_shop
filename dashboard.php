...
// Example usage:
$currentDateTime = $dashboard->getCurrentDateTime();
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        ...
        <div class="info">
          <a href="#" class="d-block">Fellah Afifah</a>
        </div>
      </div>
    ...
    <div class="row">
      ...
      <div class="col-lg-3 col-6">
        ...
        <div class="small-box bg-success">
          <div class="inner">
            <h3><?php echo $totalCustomers; ?><sup style="font-size: 20px">%</sup></h3>
            <p>Customers</p>
          </div>
          <div class="icon">
